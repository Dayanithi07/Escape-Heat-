...
> [!IMPORTANT]
> You can use either the one-shot migration (`000_full_migration.sql`) or the incremental sequence (`001` through `012`). Do not run `000` and then rerun the numbered migrations unless you intentionally want to rebuild the database from scratch.
