...
DROP POLICY IF EXISTS env_cache_select_authenticated ON public.environmental_cache;
...
DROP POLICY IF EXISTS rec_history_select_own ON public.recommendation_history;
...
DROP POLICY IF EXISTS rec_history_insert_own ON public.recommendation_history;
...
DROP POLICY IF EXISTS rec_history_update_feedback ON public.recommendation_history;
...
DROP POLICY IF EXISTS chat_history_select_own ON public.ai_chat_history;
...
DROP POLICY IF EXISTS chat_history_insert_own ON public.ai_chat_history;
...
DROP POLICY IF EXISTS reports_select_shared_anon ON public.reports;
...
DROP POLICY IF EXISTS rec_history_select_admin ON public.recommendation_history;
...
DROP POLICY IF EXISTS chat_history_select_admin ON public.ai_chat_history;
